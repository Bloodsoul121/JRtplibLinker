...
public class LogUtil {
    ...
    public static void d(Object object, String msg) {
        if (isDebug) {
            Log.d(object.getClass().getSimpleName(), "thread-" + Thread.currentThread().getName() + " " + msg);
        }
    }
    ...
    public static void e(Object object, String msg) {
        if (isDebug) {
            Log.e(object.getClass().getSimpleName(), "thread-" + Thread.currentThread().getName() + " " + msg);
        }
    }
    ...
    public static void i(Object object, String msg) {
        if (isDebug) {
            Log.i(object.getClass().getSimpleName(), "thread-" + Thread.currentThread().getName() + " " + msg);
        }
    }
    ...
    public static void v(Object object, String msg) {
        if (isDebug) {
            Log.v(object.getClass().getSimpleName(), "thread-" + Thread.currentThread().getName() + " " + msg);
        }
    }
    ...
    public static void w(Object object, String msg) {
        if (isDebug) {
            Log.w(object.getClass().getSimpleName(), "thread-" + Thread.currentThread().getName() + " " + msg);
        }
    }
}
